...
const startServer = async () => {
  try {
    ...
    if (NODE_ENV === 'production') {
      ...
      if (!STRIPE_PRICE_ID_PREMIUM) prodWarnings.push('STRIPE_PRICE_ID_PREMIUM');
      if (!STRIPE_PRICE_ID_PRO) prodWarnings.push('STRIPE_PRICE_ID_PRO');
